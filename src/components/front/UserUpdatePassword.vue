    ...
    <div class="col">
      <div class="bg-white rounded border border-2 border-black px-24 py-8" style="border-bottom: 4px solid black !important">
        <div class="d-flex flex-column gap-1 mb-8">
          ...
          <input v-model="password" class="form-control rounded-0 border border-black border-2 mb-4" placeholder="請輸入新密碼" aria-label="newPassword">
          <span class="noto-sans-tc">請再次輸入</span>
          <input v-model="confirmPassword" class="form-control rounded-0 border border-black border-2" placeholder="請再次輸入新密碼" aria-label="newPassword">
        </div>
